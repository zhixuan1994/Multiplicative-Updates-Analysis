...
# Sepcific Simulations on Lasso and Ridge constraint
x_target_ridge = np.array([-0.45, 0, 0.45])
new_m_ex3, trad_m_ex3_lasso = [], []
for i in tqdm(range(300)):
    np.random.seed(i)
    temp = np.random.normal(0,1, size=(3, 3))
    A = np.dot(temp, np.transpose(temp))
...
ax[0,0].plot(new_m_ex3[:,0],'.b', markersize=2)
ax[0,0].plot(new_m_ex3[:,1],'.r', markersize=2)
ax[0,0].plot(new_m_ex3[:,2],'.y', markersize=2)
ax[0,0].set_xticks([])
ax[0,0].set_ylabel('Estimation of v')
ax[0,0].set_title('MU with Lasso constraint')
ax[0,0].grid()

ax[0,1].plot(trad_m_ex3_lasso[:,0],'.b', markersize=2)
ax[0,1].plot(trad_m_ex3_lasso[:,1],'.r', markersize=2)
ax[0,1].plot(trad_m_ex3_lasso[:,2],'.y', markersize=2)
ax[0,1].set_xticks([])
ax[0,1].set_title('PGDL with Lasso constraint')
ax[0,1].grid()

ax[1,0].plot(new_m_ex4[:,0],'.b', markersize=2)
ax[1,0].plot(new_m_ex4[:,1],'.r', markersize=2)
ax[1,0].plot(new_m_ex4[:,2],'.y', markersize=2)
ax[1,0].set_xticks([])
ax[1,0].set_ylabel('Estimation of v')
ax[1,0].set_xlabel('Run test')
ax[1,0].set_title('MU with Ridge constraint')
ax[1,0].grid()

ax[1,1].plot(trad_m_ex4_ridge[:,0],'.b', markersize=2)
ax[1,1].plot(trad_m_ex4_ridge[:,1],'.r', markersize=2)
ax[1,1].plot(trad_m_ex4_ridge[:,2],'.y', markersize=2)
ax[1,1].set_xticks([])
ax[1,1].set_xlabel('Run test')
ax[1,1].set_title('PGDL with Ridge constraint')
ax[1,1].grid()
plt.show()
